...
COPY --from=tools /usr/local/bin/krew /usr/local/bin/krew
COPY --from=tools /usr/local/bin/talosctl /usr/local/bin/talosctl
COPY --from=tools /usr/local/bin/amtool /usr/local/bin/amtool
